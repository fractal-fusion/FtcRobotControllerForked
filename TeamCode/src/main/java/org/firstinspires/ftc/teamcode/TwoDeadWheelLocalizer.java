...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1429.131001772059; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 3011.960204840819; // x position of the perpendicular encoder (in tick units)
    }
